...
class HyperplaneComparingProgress(QWidget):
    ...
    def setup_ui(self):
        ...
        self.current_formula = QLabel(self.widget_14)
        self.current_formula.setText("")
        self.current_formula.setObjectName("current_pivot_vector")
        self.verticalLayout_11.addWidget(self.current_formula)
        ...
        self.verticalLayout_12.addWidget(self.current_comparison_results)
